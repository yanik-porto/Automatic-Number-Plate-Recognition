...
def test():
    ...
    stnlprnet = build_stnlprnet(lpr_max_len=args.lpr_max_len, phase=args.phase_train, class_num=len(CHARS),
                                dropout_rate=args.dropout_rate, batch_size=args.test_batch_size,
                                w=args.img_size[0], h=args.img_size[1])
